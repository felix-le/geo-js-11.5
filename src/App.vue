<template>
  <div id="app">
    <main class="mw6 center">
      <add-hero-btn text="Add Hero" @add-hero="addHero" />
...
const heroes = [
  ...
  },
  {
    name: 'Cyclops',
    twitter: '@oneye',
    pic: 'http://www.animatedimages.org/data/media/450/animated-marvel-avatar-image-0005.gif',
  },
  {
    name: 'Storm',
    twitter: '@rainsitpours',
    pic: 'http://www.animatedimages.org/data/media/450/animated-marvel-avatar-image-0007.gif',
  },
  {
    name: 'Phoenix',
    twitter: '@jeangrey',
    pic: 'http://www.animatedimages.org/data/media/450/animated-marvel-avatar-image-0016.gif',
  },
];
